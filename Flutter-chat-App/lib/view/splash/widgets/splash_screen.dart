    ...
    return BlocListener<AccountBloc, AccountState>(
      listener: (context, state) async {
        ...
        if (state is RegisterSucceed) {
          Functions.transition(context, MessagesScreen(friend: User(userId: "saini", name: "bot", email: "sainiprakash@gmail.com", imgUrl: "https://thumbs.dreamstime.com/b/businessman-icon-vector-male-avatar-profile-image-profile-businessman-icon-vector-male-avatar-profile-image-182095609.jpg", imageType: ImageType.network),));
